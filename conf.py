...
BLOG_AUTHOR = "Narendra Mukherjee"  # (translatable)
...
BLOG_EMAIL = "narendra.mukherjee@gmail.com"
BLOG_DESCRIPTION = "About neuroscience, statistics, Python, and some more.."  # (translatable)
